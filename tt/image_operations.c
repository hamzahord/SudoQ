...
void LineDetection(SDL_Surface *image_to_process, double sobel_threshold, double hough_threshold, char *line_color)
{
	...
	HoughTransformAngleDetection(edge_image, image_to_process, 180, 180, hough_threshold, line_color);
	
	Flip(image_to_process);
	Flip(edge_image);
	
	HoughTransformAngleDetection(edge_image, image_to_process, 180, 180, hough_threshold - 10, line_color);
	Flip(image_to_process);
